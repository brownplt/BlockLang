...
the screen width 
- [ ] Get function body displayable in pop-up alongside function use
...
- [ ] Thoroughly test everything. This needs to be more concrete.
...
- [ ] Add primitives to top-level of toolbox. (Is this possible?)
