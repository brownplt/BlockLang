...
1. Fix 'empty'
2. Disable run button at the appropriate times
3. Add explanatory tooltip over failing examples. 
4. Clean up this document, and figure out where I am exactly.

5. Switch to fish shell.
