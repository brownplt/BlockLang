...
have type-checking for the body, so you can't have an incorrect body type.

Send a message to Kathi, Emu, and Shriram with choices for body.

* Plan
- [ ] First, get results box css'ed up to look nice. Also, abstract
...
- [ ] Then send an email with updates, responses to Emu's previous
  message. 

For 25 minutes, work on the results box!
