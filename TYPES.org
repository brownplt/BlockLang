...
Thoughts on getting function definitions working:

I need to build some abstractions to communicate across blockly
instances! I want to be able to say 'make an instance from this
