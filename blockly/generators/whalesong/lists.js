...
Blockly.Whalesong.lists_repeat = function() {
  ...
  if (!Blockly.Whalesong.definitions_['lists_repeat']) {
    ...
    Blockly.Whalesong.lists_repeat.repeat = functionName;
    var func = [];
    ...
    func.push('}');
    Blockly.Whalesong.definitions_['lists_repeat'] = func.join('\n');
  }
  ...
  var code = Blockly.Whalesong.lists_repeat.repeat +
      '(' + argument0 + ', ' + argument1 + ')';
...
Blockly.Whalesong.lists_isEmpty = function() {
  ...
  return ['!' + argument0 + '.length', Blockly.Whalesong.ORDER_LOGICAL_NOT];
};
