...
/**
 * primitive : string, the name of the primitive racket function we are calling
 * args: these should be strings, generated by valueToCode
 */
...
Blockly.Whalesong.call_primitive = function (primitive /*, arguments to function */) { 
	...
	call += ')';
	// This wrapper turns the whole thing into an expression, so we can put it anywhere
	return call;
    }
}   


Blockly.Whalesong.lib_ = [];
Blockly.Whalesong.lib_["failure"] = 'function(v) { throw { message: "Failure!!!", value: v }; }';
Blockly.Whalesong.lib_["success"] = 'function(v) { _temp = v; }';
Blockly.Whalesong.lib_["prim_to_js_prim"] = "\
function(name) {\n\
